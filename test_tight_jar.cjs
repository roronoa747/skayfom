...
async function generateTightJar() {
        ...
        <svg width="0" height="0">
            <defs>
                <clipPath id="jar-clip">
                    <!-- Aggressively shaved 15 pixels off the left/right and deeply curved the bottom corners! -->
                    <path d="
                        M 15 65 
                        Q 237 25 460 65 
                        L 460 550 
    ...
    await element.screenshot({ path: 'test_tight_jar.png', omitBackground: true });
    
    await browser.close();
    console.log('Tight jar saved.');
}
