    ...
    selected.forEach((src) => {
        html += `
            <a href="https://www.instagram.com/s.kayfom_store/" target="_blank" class="w-full aspect-[4/5] bg-white/5 rounded-xl border border-white/10 overflow-hidden relative group block">
                <img src="${src}" alt="Instagram Post" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" loading="lazy" style="object-fit: contain; padding: 1rem;">
